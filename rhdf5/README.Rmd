---
title: Going from hdf5 to PointClouds
output: github_document
---

## Load 24hr data

For this Rmd file, we will try 50 files out of some ~540. According to [@martin2007discrimination], a typical dBZ to detect insects (what is an insect?) is (17). There does not seem to be a standard let a lone a gold standard value as elsewhere it was something like 0-4dbZ.
...
## bioRad
The package fails to read the Example data we despite the above reads using the same underlying package `rhdf5` package.
